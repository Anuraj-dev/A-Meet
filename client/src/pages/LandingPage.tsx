...
export default function LandingPage() {
  ...
  async function handleNewMeeting() {
    ...
    try {
      ...
      // this same account in another browser) has no marker and hits the lobby.
      navigate(`/room/${data.roomId}`, { state: { fromCreate: true } });
    } finally {
      setCreating(false);
    }
  }
    ...
    <Box
          ...
          <Stack
            ...
            <Button
              ...
              sx={{
                ...
                bgcolor: "rgba(20,15,12,0.4)",
                backdropFilter: "blur(10px)",
                "&:hover": {
                  color: DK.ink,
                  borderColor: DK.line2,
                  bgcolor: DK.surface2,
                },
              }}>
              Upcoming
      ...
      <Box
        ...
        <Typography
          ...
          Spin up a room, share a link, and everyone's together in seconds. No
          downloads, no accounts to chase, just press start.
        </Typography>
          ...
          <Box
            ...
            <Stack
              ...
              <Button
                ...
                disabled={creating}
                sx={{ ...primaryBtn, width: { xs: "100%", md: "auto" } }}>
              ...
              <Box
                ...
                <KeyboardIcon
                  sx={{ color: DK.dim, fontSize: 21, mr: 1.25, flexShrink: 0 }}
                />
                <InputBase
                  fullWidth
                ...
                <Button
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      bgcolor: joinCode.trim() ? DK.emberDark : DK.surface2,
                    },
      ...
      <Box
        ...
        <Typography
          sx={{ fontSize: 12.5, color: DK.faint, fontFamily: DK.font }}>
        ...
        <Typography
          ...
          Built by{" "}
          <Box component="span" sx={{ color: DK.dim, fontWeight: 600 }}>
            Anuraj Jit Saikia
          </Box>
        </Typography>
      </Box>
      ...
      <Drawer
        ...
        <Typography
          sx={{ fontFamily: DK.font, fontSize: 13.5, color: DK.faint, mt: 2 }}>
